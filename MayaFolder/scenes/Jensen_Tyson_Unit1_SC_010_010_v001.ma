...
//Last modified: Tue, Sep 01, 2026 03:52:18 PM
//Codeset: 1252
requires maya "2027";
requires "mtoa" "5.6.2";
...
fileInfo "UUID" "4A10EFAB-40A0-AEF2-247A-B28AE45186A1";
createNode transform -s -n "persp";
	rename -uid "9500EC05-4FAE-E408-1C4E-36BE201C5A44";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -35.408266373853991 10.522598918474042 -15.047815568902417 ;
	setAttr ".r" -type "double3" -12.338352729611655 -117.39999999997809 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E57FF329-42FB-2FB6-5904-159D130D2AFF";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 33.158157665813533;
...
createNode transform -n "Brick_1" -p "Wall_1";
	...
	setAttr ".t" -type "double3" -0.29862929869678811 7.6572663191527024 0 ;
	setAttr ".r" -type "double3" 0 0 -90 ;
...
createNode transform -n "Brick_2" -p "Wall_1";
	...
	setAttr ".t" -type "double3" -0.29862929869678811 7.6572663191527024 0.17249661255670401 ;
	setAttr ".r" -type "double3" 0 0 -90 ;
	setAttr ".s" -type "double3" 0.5 0.05 0.10333333333333333 ;
	setAttr ".rp" -type "double3" 0.25000017916857153 0 0 ;
	setAttr ".rpt" -type "double3" -0.25000017916857153 -0.25000017916857153 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F86D5FEA-4CB1-3BA1-9FD6-278D362A8DA4";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
...
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "DD6CD01C-4648-5BD5-0FDC-2E849FD33C5C";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "AF1E06A1-46DC-154D-8450-3D984605CF5A";
createNode displayLayerManager -n "layerManager";
	rename -uid "1E0DC6FB-4802-BCC7-B748-F69D0F89E557";
createNode displayLayer -n "defaultLayer";
	rename -uid "A768AACB-46D6-833F-4ADB-90BBA06F89A5";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "43166C6C-41AB-EE3D-A54E-279F1B1BB64D";
